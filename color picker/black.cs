        ...
        Dictionary<string, string> colorDictionary = new Dictionary<string, string>()
{
    ...
    { "plum", "#DDA0DD" },
        ...
        private void changToGrayToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
            Form1 ss = new Form1();
            ss.Show();
        ...
        private void changeToGreyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
            Form1 ss = new Form1();
            ss.Show();
        ...
        private void exitToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            // Store all open forms in the list
            foreach (Form form in Application.OpenForms)
            {
                formsToClose.Add(form);
            }

            // Close the forms from the separate list
        ...
        private void txtSearch_MouseDown_1(object sender, MouseEventArgs e)
        {
            txtSearch.Text = "";
        }
